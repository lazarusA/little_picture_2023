...
function load_img(; bgc = :black, scity="jena")
    path = "./little_pictures/$(bgc)/rainfall_weekly_$(scity).png"
...
rowgap!(fig.layout, 5)
fig
save("./little_pictures/black/grid_black_weekly.png", fig)
...
rowgap!(fig.layout, 5)
fig
save("./little_pictures/white/grid_white_weekly.png", fig)